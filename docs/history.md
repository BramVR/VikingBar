...
The usage section places today's usage and the observed cycle total above an inline chart. The adjacent panel keeps the selected date, amount, observation status, estimate, and scope explanation together. The existing balance layout, selectors, and menu actions remain unchanged.
