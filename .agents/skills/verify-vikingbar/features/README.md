...
- [Latest bill and PDF](invoices.md). Verify account and grouped invoice scope, separate payment fields, empty states, and explicit private PDF downloads. Historical invoice API and combined native passes are recorded; current post-merge and compact-navigation maintenance remain pending.
