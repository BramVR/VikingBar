...
- [Latest bill and PDF](invoices.md). Verify account and grouped invoice scope, separate payment fields, empty states, and explicit private PDF downloads. Current compact Bills navigation and API comparison passed; the final release stored-session continuation remains pending.
