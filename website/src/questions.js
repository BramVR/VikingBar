export const questions = [
    ...
    ['Can anyone download VikingBar?', 'Yes. The free unsigned preview is available from GitHub without an account for Apple Silicon Macs running macOS 14 or later. It is not Developer ID signed or notarized. If macOS blocks the first launch, open System Settings, choose Privacy & Security, then click Open Anyway. Updates may require approval again.'],
